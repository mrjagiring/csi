...
class Staff extends CActiveRecord
{
	...
	public function rules()
	{
		...
		return array(
			array('name, code, address, phone, email, department', 'required'),
			array('name, phone, email, department', 'length', 'max'=>50),
			...
			array('id, name, code, address, phone, email, department', 'safe', 'on'=>'search'),
		);
	}
